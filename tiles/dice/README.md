...
No Background is a 250-coin skin in Shop → Tile Skins, registered in the server product catalog. After purchase it appears as owned in each Dice tile’s skin drawer. Open the stacked-squares button beside customization to apply it, or choose Default to restore the background. Its controls fade when the tile is not hovered or focused. Reduced-motion preferences disable tumbling.

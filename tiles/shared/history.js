...
(()=>{
  ...
  function begin(event){
    ...
    if(event.target.closest?.('.module-delete,.module-tab-add,.tile-tab-strip,.tile-reset-scale,.resize-handle,.module-drag-handle,.tile-skins-toggle')||m.dataset.type==='draw'&&event.target.closest?.('canvas'))return;
